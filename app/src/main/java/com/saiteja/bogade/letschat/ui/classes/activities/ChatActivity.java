...
import com.saiteja.bogade.letschat.LetsChatApplication;
import com.saiteja.bogade.letschat.R;
import com.saiteja.bogade.letschat.ui.classes.fragments.ChatFragment;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        LetsChatApplication.setChatActivityOpen(true);
    }

    @Override
    protected void onPause() {
        super.onPause();
        LetsChatApplication.setChatActivityOpen(false);
    }
}
